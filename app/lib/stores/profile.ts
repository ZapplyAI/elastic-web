...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('elasticApp_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('elasticApp_profile', JSON.stringify(profileStore.get()));
  }
};
