  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-elasticApp-elements-borderColor bg-elasticApp-elements-background-depth-1 text-elasticApp-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-elasticApp-elements-textSecondary', className)} {...props} />;
  },
);
