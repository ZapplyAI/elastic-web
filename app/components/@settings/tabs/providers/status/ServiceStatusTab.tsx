      ...
      >
        <div className="flex items-center justify-between gap-2 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-elasticApp-elements-textPrimary">Service Status</h4>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-elasticApp-elements-background-depth-3 hover:bg-elasticApp-elements-background-depth-4',
        ...
        <div className="p-4 bg-elasticApp-elements-background-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-elasticApp-elements-textPrimary mb-2">Test API Key</h5>
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-elasticApp-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-elasticApp-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-elasticApp-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-elasticApp-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-elasticApp-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
