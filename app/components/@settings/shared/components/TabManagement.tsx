      ...
      >
        ...
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-elasticApp-elements-textPrimary">Tab Management</h4>
              <p className="text-sm text-elasticApp-elements-textSecondary">Configure visible tabs and their order</p>
            </div>
          </div>
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className={classNames(
                ...
                'border border-elasticApp-elements-borderColor',
                'text-elasticApp-elements-textPrimary',
                'placeholder-elasticApp-elements-textTertiary',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              ...
              <span className="text-sm font-medium text-elasticApp-elements-textPrimary">Default Tabs</span>
            </div>
          )}
          ...
          {filteredTabs
            ...
            .map((tab, index) => (
              <motion.div
                key={tab.id}
                className={classNames(
                  'rounded-lg border bg-elasticApp-elements-background text-elasticApp-elements-textPrimary',
                  'bg-elasticApp-elements-background-depth-2',
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'bg-elasticApp-elements-background-depth-3 group-hover:bg-elasticApp-elements-background-depth-4',
                      'transition-all duration-200',
                      tab.visible ? 'text-purple-500' : 'text-elasticApp-elements-textSecondary',
                    )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="text-sm font-medium text-elasticApp-elements-textPrimary group-hover:text-purple-500 transition-colors">
                            {TAB_LABELS[tab.id]}
                          </h4>
                          {BETA_TABS.has(tab.id) && <BetaLabel />}
                        </div>
                        <p className="text-xs text-elasticApp-elements-textSecondary mt-0.5">
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              ...
              <span className="text-sm font-medium text-elasticApp-elements-textPrimary">Optional Tabs</span>
            </div>
          )}
