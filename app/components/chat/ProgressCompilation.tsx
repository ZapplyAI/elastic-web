  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={classNames(
            'bg-elasticApp-elements-item-backgroundAccent',
            'p-1 rounded-lg text-elasticApp-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className={classNames(
              'p-1 rounded-lg bg-elasticApp-elements-item-backgroundAccent hover:bg-elasticApp-elements-artifacts-backgroundHover',
            )}
